...
const messages: Record<Language, Record<string, string>> = {
  en: {
    ...
    'settings.codexAria': 'Upgrade codex',
    'settings.codexTitle': 'Upgrade Codex',
    'settings.codexShip': 'Stormraider Interceptor',
    'settings.codexRule': 'Traits grow through levels 1-6, then level 7 becomes an Ultra evolution. A full run can hold up to three Ultra traits; the rest stay capped at level 6.',
    ...
    'start.controlsBody': 'Move with WASD or drag. Skills use 1/2/3, SP clears danger.',
  ...
  zh: {
    ...
    'settings.paused': '暂停中',
    'settings.codexAria': '词条图鉴',
    'settings.codexTitle': '词条图鉴',
    'settings.codexShip': '雷霆拦截机',
    'settings.codexRule': '词条会从 1-6 级持续成长，第 7 级会超进化为 Ultra。一局最多拥有 3 个 Ultra，其他词条会停在 6 级上限。',
    ...
    'start.controlsBody': 'WASD 或拖动移动。1/2/3 释放技能，SP 清理危险。',
